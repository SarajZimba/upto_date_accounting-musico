...
class AccountLedger(AccountBaseModel):
    ...
    idcredit = models.CharField(max_length=155, null=True, blank=True)
...
class TblJournalEntry(AccountBaseModel):
    ...
    narration = models.CharField(default='-',max_length=300, null=True, blank=True)
